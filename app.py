...
LANG_MAP = {
    "HR 🇭🇷": {
        ...
        \n**Zašto odabrati nas?**
        \nVjerujemo da se prava kvaliteta ne može postići industrijskom brzinom. Naša stoka dolazi isključivo od malih, provjerenih uzgajivača s pašnjaka Lonjskog polja, Banovina i Posavine. Meso pripremamo polako, uz prirodne začine i bez nepotrebnih aditiva.""",
    ...
    "EN 🇬🇧": {
        ...
        "note_vaga": """⚖️ **Note on weighing:** Prices are fixed, but the exact total will be known after weighing. You will know the final amount upon delivery. We strive to minimize the difference between informative and final amounts.""",
        "note_delivery": """🚚 **Delivery & Payment:** Items will be delivered to your home address or you can redirect them to a parcel locker. Payments are **exclusively cash on delivery**.""",
        ...
        "horeca_text": "As a family business, we deeply value our catering colleagues. We offer authentic beech smoke aroma, safe refrigerated delivery, and full wholesale support in 2026.",
        "haccp_title": "Food Safety: Field to Table",
        "haccp_text": "In 2026, we apply the strictest standards. Full traceability, strict HACCP protocols, and sterile conditions are our foundation.",
        "info_title": "Our Story: Family and Quality",
        "info_text": "Located in Sisak, we preserve traditional skills. We believe true quality cannot be rushed, using livestock from verified local breeders.",
    ...
    "DE 🇩🇪": {
        ...
        "cart_title": "👜 Ihre Tasche", "cart_empty": "Ihre Tasche ist leer.",
        "note_vaga": """⚖️ **Wiegehinweis:** Die Preise sind fest, der Endbetrag wird nach dem Wiegen ermittelt. Sie zahlen bei Lieferung per Nachnahme.""",
        "note_delivery": """🚚 **Lieferung:** Zustellung an Ihre Adresse oder Paketstation. Zahlungen sind **ausschließlich per Nachnahme** möglich.""",
        ...
        "horeca_title": "Vertrauen und Tradition",
        "horeca_text": "Authentisches Raucharoma, eigene Kühlfahrzeuge und Großhandelsunterstützung für unsere Partner im Jahr 2026.",
        "haccp_title": "Lebensmittelsicherheit 2026",
        "haccp_text": "Vollständige Rückverfolgbarkeit und höchste Hygienestandards in allen Produktionsphasen.",
        "info_title": "Unsere Geschichte",
        "info_text": "Seit Generationen in Sisak, verarbeiten wir Fleisch regionaler Bauern nach traditioneller Art ohne unnötige Zusatzstoffe.",
