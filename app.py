...
# --- VIŠEJEZIČNI RJEČNIK S POTPUNIM PRIJEVODIMA ---
LANG = {
    "HR 🇭🇷": {
        ...
        "fname": "Ime*", "lname": "Prezime*", "tel": "Kontakt telefon*", "country": "Država*", "city": "Grad/Mjesto*", "addr": "Ulica i kućni broj*",
    ...
    "EN 🇬🇧": {
        ...
        "about_txt": "### Family Tradition and Vision\nThe Kojundžić family has for generations been synonymous with top-tier butchery expertise in the Sisak-Moslavina County. Our approach is based on a blend of historical recipes from the Sisak region and modern technological processes. Each piece of meat is manually processed by our master butchers, ensuring that the texture and quality meet the highest gourmet standards. Our smokehouse uses exclusively dry beech and hornbeam wood, achieving that recognizable, mild smoke scent that has become our trademark.",
    ...
    "DE 🇩🇪": {
        ...
        "fname": "Vorname*", "lname": "Nachname*", "tel": "Telefon*", "country": "Land*", "city": "Stadt*", "addr": "Straße & Hausnummer*",
    ...
    with t1: # SHOP S ISPRAVLJENOM LOGIKOM VAGE
        ...
        for i in range(18):
            ...
            with (c1 if i % 2 == 0 else c2):
                ...
                if UNITS[i] == "kg":
                    if cq == 0.0 and nq == 0.5: nq = 1.0; st.session_state.cart[pid] = 1.0; st.rerun()
                    elif cq == 1.0 and nq == 0.5: nq = 0.0; st.session_state.cart.pop(pid, None); st.rerun()
...
with col_right:
    ...
    with st.form("form_final"):
        ...
        f_drzava = st.selectbox(T["country"], options=EU_DRZAVE)
